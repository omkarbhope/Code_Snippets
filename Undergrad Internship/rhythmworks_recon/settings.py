...
MEDIA_URL =  '/network_member_attachments/'
MEDIA_ROOT = os.path.join(BASE_DIR, "network_member_attachments")
...
DATABASES = {
    ...
    'default': {
        ...
        'NAME': 'rhythmfl_bankrecondev',

        'USER': 'rhythmfl_bankrecon_dev',

        'PASSWORD': 'Rhythmflows@2020',
